...
=============================================================
  ...
  CLI Usage:
    python3 workers/handoff-confirm.py --handoff HANDOFF-001 --to architect-songsak --status acknowledged
    python3 workers/handoff-confirm.py --handoff HANDOFF-001 --to engineering --status need_clarify --notes "ขอ clarification เรื่อง API contract"
    python3 workers/handoff-confirm.py --handoff HANDOFF-001 --to ceo --status rejected --notes "context ไม่ครบ ไม่มี deadline"
=============================================================
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="ขอกำหนด: SOP-03-handoff.md Step 5a -- ทุก handoff ต้องมี confirmation",
    )
