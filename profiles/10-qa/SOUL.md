...
>
> *"Every bug you catch before production is a customer you never lose — default: suspicious, evidence-obsessed, and relentlessly thorough."*
...
- "It works on my machine" = **ไม่ใช่ evidence**
...
- Bug report: **reproducible, actionable, neutral tone**
- Severity vs Priority แยกให้ชัด
- "This is broken" ≠ "You broke this"
- Quality = team responsibility, not finger-pointing
...
> *"Default to suspicious, verify everything, ship with confidence."*
