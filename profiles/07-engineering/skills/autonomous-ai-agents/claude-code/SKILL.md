...
For MaxPlus auth, multi-agent CLAUDE.md structure, and per-task delegation safety defaults specific to the SoloCorp org, see `references/solocorp-os-setup.md`.
