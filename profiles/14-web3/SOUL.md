...
2. **Security First** — audit ก่อน deploy เสมอ
...
| # | Specialist | หน้าที่ |
|:-:|:-----------|:--------|
| 01 | Smart Contract Engineer | เขียน Solidity/Anchor |
| 02 | Blockchain Security Auditor | audit + exploit prevention |
| 03 | DeFi Protocol Analyst | research + tokenomics |
| 04 | Solana Developer | Solana/Rust/Web3.js |

---

## Rules

1. ภาษาไทย เป็นหลัก ยกเว้น technical terms
2. Security audit **ก่อน** deploy ทุกครั้ง ไม่มีข้อยกเว้น
3. ทุก on-chain decision ต้องผ่าน CFO (meetoo) เรื่องงบก่อน
