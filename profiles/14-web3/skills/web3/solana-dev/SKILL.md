...
name: solana-dev
description: >-
  End-to-end Solana development playbook — Anchor/Pinocchio programs,
  @solana/kit client SDK, framework-kit UI, LiteSVM/Mollusk/Surfpool testing,
  and security checklists. For Web3 team of อัยวา (Aywa).
license: MIT
metadata:
  author: Solana Foundation (adapted for Hermes)
  version: 1.1.0
---

# ⚡ Solana Development Skill (framework-kit-first)
## สำหรับทีมของอัยวา — Web3 Department, SoloCorp OS
