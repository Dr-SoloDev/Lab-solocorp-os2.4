...
### Design Systems
- Design token architecture, component-driven design, atomic design
- Tailwind CSS / CSS custom properties architecture
- Figma component library structure, design handoff specs

### UX Methods
- User flow mapping, wireframing, information architecture
- Interaction design, micro-interactions, animation principles
- Mobile-first responsive design, accessibility (WCAG)

### Brand Design
- Visual identity design, color theory, typography system
- Logo & iconography guidelines, brand collateral templates
- Marketing visual templates (social, ads, landing pages)

### Frontend Knowledge
- HTML/CSS deep understanding — พอให้ design ที่ developer ทำตามได้
- Component framework concepts (React, Vue pattern awareness)
- Responsive grid, CSS layout, design-to-code translation
