...
PROJECT_PATH = Path(__file__).parent.parent.parent / "bangkok-pos"
TARGET_SCORE = 7
MAX_ROUNDS = 10

SCORE_PROMPT = """คุณคือ QA ทีม ของ SoloCorp — ประเมินคะแนนโปรเจกต์ bangkok-pos

ตรวจสอบจริงใน $(git rev-parse --show-toplevel 2>/dev/null || pwd):
...
GAP_TASKS = {
    ...
    "db_seed":("s-seed", "engineering", "high",   "รัน npx prisma db seed ในโฟลเดอร์โปรเจกต์"),
